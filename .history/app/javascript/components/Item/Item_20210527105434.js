  ...
  useEffect(() => {
    ...
    const getItem = async () => {
      ...
      if (response.ok) {
        ...
        setState({ ...item, name: itemData.attributes.name, description: response.data.data.attributes.description, cost: response.data.data.attributes.cost, id: itemData.id })
        // setItem({ ...item, name: c });
